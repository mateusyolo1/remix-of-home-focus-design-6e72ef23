...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Major+Mono+Display&display=swap" },
    ],
  }),
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body>
        {/* Liquid Glass uses only backdrop-filter + inset shadow — no SVG filter needed. */}
        {children}
        <Scripts />
      </body>
    </html>
